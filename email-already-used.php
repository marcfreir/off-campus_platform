...
/* 
    ...
    Created on    : 07-Feb-2019, 04:07:45 AM
    Author        : Marc Freir
...
<?php
    ...
    if (isset($_SESSION['session_email_already_used']))
    {
        $message = "Já existe um perfil com o e-mail fornecido.";
        //echo "<br><hr><br>";
