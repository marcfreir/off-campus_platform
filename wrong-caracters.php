...
/* 
    ...
    Created on    : 07-Feb-2019, 03:54:28 AM
    Author        : Marc Freir
...
<?php
    ...
    if (isset($_SESSION['session_wrong_caracters']))
    {
        $message = "Os carácters digitados não são aceitos.";
        //echo "<br><hr><br>";
...
?>
<title>Caracteres Errados</title>
<?php
        ...
        <div class="message">
                <div class="text-center">
                    <div class="text-top">
                        ...
                        <p>Tenha certeza que os carácters tenha essa combinação: <strong>a-z; A-Z; 0-9; _</strong>.</p>
                        <br><hr><br>
