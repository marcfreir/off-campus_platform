...
/* 
    ...
    Created on    : 07-Feb-2019, 04:16:18 AM
    Author        : Marc Freir
...
<?php
    ...
    if (isset($_SESSION['session_invalid_username']))
    {
        $message = "O nome de usuário (username) fornecido é inválido.";
        //echo "<br><hr><br>";
...
?>
<title>Nome de Usuário Inválido</title>
<?php
        ...
        <div class="message">
                <div class="text-center">
                    <div class="text-top">
                        ...
                        <p>Tenha certeza que o nome de usuário possue de 3 a 32 carácteres.</p>
