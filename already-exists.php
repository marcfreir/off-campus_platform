...
/* 
    ...
    Created on    : 07-Feb-2019, 04:23:45 AM
    Author        : Marc Freir
...
<?php
    ...
    if (isset($_SESSION['session_already_exists']))
    {
        $message = "O nome de usuário (username) fornecido já existe.";
        //echo "<br><hr><br>";
...
?>
<title>Nome de Usuário Já Existe</title>
<?php
        ...
        <div class="message">
                <div class="text-center">
                    <div class="text-top">
                        ...
                        <p>Tente combinar letras e números.</p>
